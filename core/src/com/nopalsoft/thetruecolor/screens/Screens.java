...
public abstract class Screens extends InputAdapter implements Screen {
    ...
    public com.nopalsoft.thetruecolor.TrueColorGame game;

    public OrthographicCamera oCam;
    public SpriteBatch batcher;
    public Stage stage;

    public Screens(final com.nopalsoft.thetruecolor.TrueColorGame game) {
    ...
    public void changeScreenWithFadeOut(final Class<?> newScreen, final com.nopalsoft.thetruecolor.TrueColorGame game) {
